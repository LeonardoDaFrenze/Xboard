...
class Handler extends ExceptionHandler
{
    ...
    public function render($request, Throwable $exception)
    {
        if ($exception instanceof ViewException) {
            return $this->fail([500, 'Theme rendering failed. If you updated the theme, parameters may have changed — please reconfigure the theme.']);
        }
        // ApiException — explicitly thrown errors
